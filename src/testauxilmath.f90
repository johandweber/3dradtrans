...
!=============================================================================
  write(*,*) "With optional info argument :"
  write(*,*) "============================="
  write(*,*)
  write(*,*) "soluation of (x-1) = 0"
...
! one double real andn son single real solution
  ...
  write(*,*)
  write(*,*) "solution of (x-1) * (x-2) * (x-3) * (x-4) = 0"
  write(*,*) solveb(1._dp, -8._dp, +35._dp, -50._dp, +24._dp)
  write(*,*)
  write(*,*)
!
!  Table of faculties
